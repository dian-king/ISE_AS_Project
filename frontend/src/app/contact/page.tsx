...
export default function ContactPage() {
  ...
  const inputClass = "w-full border border-gray-200 dark:border-gray-600 rounded-xl px-3.5 py-2.5 text-sm bg-white dark:bg-gray-700/60 text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#0D4A2F] dark:focus:ring-green-500 focus:border-transparent transition-shadow";
          ...
          <div className="space-y-5">
            <div className="bg-white dark:bg-gray-800/60 rounded-2xl border border-gray-100 dark:border-gray-700 p-6 shadow-sm">
              ...
              <div className="space-y-4 text-sm text-gray-600 dark:text-gray-300">
                <div className="flex items-start gap-3">
                  <svg className="w-5 h-5 text-[#0D4A2F] dark:text-green-400 mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="flex items-center gap-3">
                  <svg className="w-5 h-5 text-[#0D4A2F] dark:text-green-400 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
                  <span>admissions@greenwood.rw</span>
                </div>
                <div className="flex items-center gap-3">
                  <svg className="w-5 h-5 text-[#0D4A2F] dark:text-green-400 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="bg-white dark:bg-gray-800/60 rounded-2xl border border-gray-100 dark:border-gray-700 p-6 shadow-sm">
              ...
              <div className="space-y-1.5 text-sm text-gray-600 dark:text-gray-300">
                <div className="flex justify-between"><span>Monday – Friday</span><span className="font-semibold text-gray-900 dark:text-white">07:30 – 16:30</span></div>
                <div className="flex justify-between"><span>Saturday</span><span className="font-semibold text-gray-900 dark:text-white">08:00 – 12:00</span></div>
                <div className="flex justify-between"><span>Sunday</span><span className="text-gray-400">Closed</span></div>
              </div>
            </div>

            <div className="bg-[#0D4A2F] rounded-2xl p-5 text-white text-sm shadow-sm">
              ...
              <Link href="/register" className="bg-[#C9A227] text-[#082D1D] font-semibold px-4 py-2 rounded-xl hover:bg-[#E8C85A] transition-colors inline-block text-sm">
                Apply Now
              </Link>
            </div>
          </div>
          ...
          <div className="md:col-span-2">
            {submitted ? (
              <div className="bg-white dark:bg-gray-800/60 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm p-12 text-center">
                <div className="w-16 h-16 bg-[#0D4A2F]/10 dark:bg-green-900/20 rounded-full flex items-center justify-center mx-auto mb-5">
                ...
                <Link href="/register" className="bg-[#0D4A2F] text-white font-semibold px-6 py-2.5 rounded-xl hover:bg-[#0a3d26] transition-colors inline-block">
              ...
              <div className="bg-white dark:bg-gray-800/60 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <button
                    type="submit"
                    disabled={isLoading}
                    className="w-full bg-[#0D4A2F] text-white font-semibold py-3 rounded-xl hover:bg-[#0a3d26] transition-colors disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                  >
                    {isLoading ? (
                      <>
